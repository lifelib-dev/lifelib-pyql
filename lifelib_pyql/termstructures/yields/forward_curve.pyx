...
cdef class Meta(type):
    def __getitem__(cls, I):
        return globals()[f"{I.__name__}InterpolatedForewardCurve"]


class InterpolatedForwardCurve(metaclass=Meta):
...
cdef class LinearInterpolatedForwardCurve(YieldTermStructure):
    ...
    """
    def __init__(self, list dates, vector[Rate] forwards,
        ...
        self._thisptr.reset(
            new _fc.InterpolatedForwardCurve[intpl.Linear](
                _dates, forwards, deref(day_counter._thisptr),
                cal._thisptr
            )
        )

    cdef inline _fc.InterpolatedForwardCurve[intpl.Linear]* curve(self) noexcept nogil:
        return <_fc.InterpolatedForwardCurve[intpl.Linear]*>self._thisptr.get()
...
cdef class LogLinearInterpolatedForwardCurve(YieldTermStructure):
    ...
    def __init__(self, list dates, vector[Rate] forwards,
        ...
        self._thisptr.reset(
            new _fc.InterpolatedForwardCurve[intpl.LogLinear](
                _dates, forwards, deref(day_counter._thisptr),
                cal._thisptr
            )
        )

    cdef inline _fc.InterpolatedForwardCurve[intpl.LogLinear]* curve(self) noexcept nogil:
        return <_fc.InterpolatedForwardCurve[intpl.LogLinear]*>self._thisptr.get()
...
cdef class BackwardFlatInterpolatedForwardCurve(YieldTermStructure):
    ...
    def __init__(self, list dates, vector[Rate] forwards,
        ...
        self._thisptr.reset(
            new _fc.InterpolatedForwardCurve[intpl.BackwardFlat](
                _dates, forwards, deref(day_counter._thisptr),
                cal._thisptr
            )
        )

    cdef inline _fc.InterpolatedForwardCurve[intpl.BackwardFlat]* curve(self) noexcept nogil:
        return <_fc.InterpolatedForwardCurve[intpl.BackwardFlat]*>self._thisptr.get()
...
cdef class CubicInterpolatedForwardCurve(YieldTermStructure):
    ...
    def __init__(self, list dates, vector[Rate] forwards,
        ...
        self._thisptr.reset(
            new _fc.InterpolatedForwardCurve[intpl.Cubic](
                _dates, forwards, deref(day_counter._thisptr),
                cal._thisptr
            )
        )

    cdef inline _fc.InterpolatedForwardCurve[intpl.Cubic]* curve(self) noexcept nogil:
        return <_fc.InterpolatedForwardCurve[intpl.Cubic]*>self._thisptr.get()
...
ForwardCurve = BackwardFlatInterpolatedForwardCurve
