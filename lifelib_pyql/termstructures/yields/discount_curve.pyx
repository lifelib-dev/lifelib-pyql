...
from lifelib_pyql.types cimport DiscountFactor
...
cdef class LinearInterpolatedDiscountCurve(YieldTermStructure):
    ...
    cdef inline _dc.InterpolatedDiscountCurve[intpl.Linear]* curve(self) noexcept nogil:
        return <_dc.InterpolatedDiscountCurve[intpl.Linear]*>self._thisptr.get()
...
cdef class LogLinearInterpolatedDiscountCurve(YieldTermStructure):
    ...
    cdef inline _dc.InterpolatedDiscountCurve[intpl.LogLinear]* curve(self) noexcept nogil:
        return <_dc.InterpolatedDiscountCurve[intpl.LogLinear]*>self._thisptr.get()
...
cdef class BackwardFlatInterpolatedDiscountCurve(YieldTermStructure):
    ...
    cdef inline _dc.InterpolatedDiscountCurve[intpl.BackwardFlat]* curve(self) noexcept nogil:
        return <_dc.InterpolatedDiscountCurve[intpl.BackwardFlat]*>self._thisptr.get()
...
cdef class CubicInterpolatedDiscountCurve(YieldTermStructure):
    ...
    def __init__(self, list dates, vector[DiscountFactor] dfs,
        ...
        self._thisptr.reset(
            new _dc.InterpolatedDiscountCurve[intpl.Cubic](
                _dates, dfs, deref(day_counter._thisptr),
                cal._thisptr
            )
        )

    cdef inline _dc.InterpolatedDiscountCurve[intpl.Cubic]* curve(self) noexcept nogil:
        return <_dc.InterpolatedDiscountCurve[intpl.Cubic]*>self._thisptr.get()
